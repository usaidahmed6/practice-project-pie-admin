...
const EventSpecialRef = collection(db, 'EventSpecial');
const FrozenProductRef = collection(db, 'FrozenProduct');
const SeasonalProductRef = collection(db, 'SeasonalProduct');
const BreadsCroissantRef = collection(db, 'BreadsCroissant');
